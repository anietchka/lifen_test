# == Deuxième partie : TDD
#
# L'exercice ci-dessous est tiré du site [Exercism](https://exercism.org).
# Complétez simplement le fichier pour que tous les tests passent, en traitant
# ces tests l'un après l'autre. (Autrement dit : faire en sorte que le premier
# test passe, puis activer le second test et modifier le code pour que celui-ci
# passe également, puis activer le troisième test, etc.
...
class Clock
  ...
  def addition(clock)
    clock.hours * MINUTES_IN_HOUR + clock.minutes
  end
